...
const DeleteConfirmationModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 bg-opacity-50 p-4">
      {/* Modal Box */}
      <div className="w-96 rounded-lg bg-white p-6 shadow-xl border border-pink-100">
        {/* Icon & Title Header */}
        ...
        <div className="mt-6 flex justify-end gap-4">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={isDeleting}
            className="flex items-center gap-2 rounded-lg bg-rose-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-rose-700 transition-colors cursor-pointer disabled:opacity-60"
          >

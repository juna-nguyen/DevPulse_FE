...
const FilterSection = ({
  ...
  return (
    <div className="space-y-6 rounded-3xl border border-pink-100 bg-white p-6 shadow-sm">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-pink-100 bg-pink-50/40 py-2.5 pr-4 pl-10 text-sm text-slate-800 placeholder:text-slate-400 focus:border-pink-300 focus:bg-white focus:outline-none focus:ring-4 focus:ring-pink-100"
          />
        </div>

        {/* Sort Select */}
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-2 rounded-2xl border border-pink-100 bg-pink-50/40 px-3.5 py-2 text-sm text-slate-700">
      ...
      <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-pink-50">

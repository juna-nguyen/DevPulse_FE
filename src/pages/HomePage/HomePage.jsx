...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-pink-50/50 font-sans text-slate-900 selection:bg-pink-400 selection:text-white">
      {/* Toast Notifications */}
      ...
      {/* Custom Delete Confirmation Modal (Tailwind CSS) */}
